                    ...
                    <div style={styles.centerDivLeft}>
                        <div style={styles.yearContainer}>
                            ...
                            <div style={styles.topicSuperContainer}>
                                <TopicContainer style={styles.topicContainer} title="Number and Place Value" description="The learner will start to count to 100 in multiples of 1, 2, 5, and 10. They will also learn to represent numbers using pictures." icon={placeValue} iconAlt="Place Value" yearNum="1" />
