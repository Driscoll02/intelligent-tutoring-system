                    ...
                    <div style={styles.centerDivLeft}>
                        <div style={styles.yearContainer}>
                            ...
                            <div style={styles.topicSuperContainer}>
                                ...
                                <TopicContainer style={styles.topicContainer} title="Statistics" description="Here, the learner will learn to interpret and create many different types of graphs." icon={statistics} iconAlt="Statistics" />
                            </div>
                        </div>
                        <div style={styles.yearContainer}>
                            <div style={{textAlign: 'center', overflow: 'hidden', fontFamily: 'Lato', fontWeight: 400,}}>
                            ...
                            <div style={styles.topicSuperContainer}>
                                ...
                                <TopicContainer style={styles.topicContainer} title="Statistics" description="Here, the learner will learn how to use time graphs." icon={statistics} iconAlt="Statistics" />
                            </div>
                        </div>
                        <div style={styles.yearContainer}>
                            <div style={{textAlign: 'center', overflow: 'hidden', fontFamily: 'Lato', fontWeight: 400,}}>
                            ...
                            <div style={styles.topicSuperContainer}>
                                ...
                                <TopicContainer style={styles.topicContainer} title="Measurement" description="In addition to learning weight, volume, time, money, length, and height, they will also learn how to measure temperature." icon={measurementIcon} iconAlt="Measurement" />
                                <TopicContainer style={styles.topicContainer} title="Geometry - Properties of Shapes" description="The learner will begin to describe 2D and 3D shapes using accurate terminology." icon={shapes} iconAlt="Properties of Shapes" />
                                <TopicContainer style={styles.topicContainer} title="Statistics" description="Here, the learner will learn to read and create number lines." icon={statistics} iconAlt="Statistics" />
                            </div>
                        </div>
                        <div style={styles.yearContainer}>
                            <div style={{textAlign: 'center', overflow: 'hidden', fontFamily: 'Lato', fontWeight: 400,}}>
                            ...
                            <div style={styles.topicSuperContainer}>
                                <TopicContainer style={styles.topicContainer} title="Number and Place Value" description="Here, the learner will begin to compare and order numbers from 1 to 100, and will begin to recognise the place value for two digit numbers. They will also learn how to use greater than (>), and less than (<) symbols." icon={placeValue} iconAlt="Place Value" />
                                <TopicContainer style={styles.topicContainer} title="Addition, Subtraction, Multiplication and Division" description="In year 2, the learner will solve addition and subtraction problems involving numbers, measures, and quantities." icon={additionSubtraction} iconAlt="Addition and Subtraction" />
                                <TopicContainer style={styles.topicContainer} title="Ratio and Proportion" description="In year 2, the learner will solve multiplication and division problems using the 2, 3, 5, and 10 multiplication tables." icon={ratio} iconAlt="Ratio and Proportion" />
                                <TopicContainer style={styles.topicContainer} title="Fractions" description="Here, the learner will continue to learn about halves, and quarters, however, they will also be introduced to thirds. They will also gain an understanding of terminology such as equivelence, denominator, and numerator." icon={fractions} iconAlt="Fractions" />
                                <TopicContainer style={styles.topicContainer} title="Measurement" description="In addition to learning weight, volume, time, money, length, and height, they will also learn how to measure temperature." icon={measurementIcon} iconAlt="Measurement" />
                                <TopicContainer style={styles.topicContainer} title="Algebra" description="In addition to learning weight, volume, time, money, length, and height, they will also learn how to measure temperature." icon={algebra} iconAlt="Algebra" />
                                <TopicContainer style={styles.topicContainer} title="Statistics" description="Here, the learner will learn to read and create pie charts and line graphs." icon={statistics} iconAlt="Statistics" />
                            </div>
                        </div>
                    </div>
